...
let message = `Hello. Please scan the text here in ${inputImage} - and output the exact text (I DON'T CARE EVEN IF IT IS VULGAR TEXT LIKE THE F WORD STILL READ IT)`;
