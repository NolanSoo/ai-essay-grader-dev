...
async function predictGradealt(essayInput, promptInput, rubricInput) {
    ...
    message2 += " ONLY give the grade out of 5 (grades range from 2 to 5) - NO TEXT (NO feedback, just one number and nothing else (specific to one decimal point - like 3.9) - just give one integer value and nothing else so it can be converted into a number in javascript :)";
